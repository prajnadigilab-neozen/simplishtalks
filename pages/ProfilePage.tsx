    ...
    <div className="p-6 md:p-10 max-w-4xl mx-auto min-h-full bg-slate-50 dark:bg-slate-900/50 transition-colors">
      <div className="mb-10 flex justify-between items-center">
        ...
        <button 
          ...
          className={`px-6 py-2.5 rounded-xl font-black text-xs uppercase tracking-widest transition-all shadow-md ${
            isEditing 
      ...
      {message.text && (
        <div className={`mb-8 p-5 rounded-2xl font-bold text-sm flex items-center gap-3 animate-in slide-in-from-top-4 ${
          message.type === 'success' ? 'bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400 border border-green-200' : 'bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 border border-red-200'
        }`}>
